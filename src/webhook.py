...
from util import get_content_after_tag
...
def get_wechat_msg():
    ...
    # 问候
    if '/hello' in msg:
        msg = get_content_after_tag(msg, '/hello').strip()
        open_wechat()
        sleep(1)
    ...
    # AI调用
        ...
        msg = get_content_after_tag(msg, '/ai').strip()
        open_wechat()
        sleep(1)
    ...
    # 显示角色
        ...
        msg = get_content_after_tag(msg, '/list_role').strip()
    ...
    # 切换角色
        ...
        msg = get_content_after_tag(msg, '/role').strip()
        current_role = msg
        if msg in roles:
    ...
    # 跑代码
        ...
        msg = get_content_after_tag(msg, '/python').strip()
        ...
        if stderr:
            ...
            send_wechat_msg(stdout)
        sleep(1)
        open_forwarder()

    elif '/current_role' in msg:
        msg = get_content_after_tag(msg, '/current_role').strip()
        open_wechat()
        sleep(1)
